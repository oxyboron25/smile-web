    ...
    <div className="relative mt-6 space-y-6 border border-gray-600 p-6 rounded-xl shadow-md bg-gray-800/40">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="flex items-center rounded-md border-2 border-[#6F5252] bg-transparent">
          {/* Country code area: sized according to content */}
          <div className="relative inline-flex items-center px-3 border-r-2 border-[#6F5252]">
            {/* Visible selected code (determines width) */}
            <span className="text-white">{selectedCode || "+--"}</span>

            {/* Invisible select sits on top for accessibility/keyboard support */}
            <select
              ...
              onChange={(e) => {
                ...
                setSelectedCode(val);
                // call the registered onChange if provided to keep RHF state in sync
            ...
            {/* spacer to add extra gap between the country code and the arrow */}
