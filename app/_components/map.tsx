  ...
  return (
    <section className="relative w-full bg-[#001612 ] px-8 py-16">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row justify-between">
        ...
        <div className="mb-8 lg:mb-0">
          <h2 className="text-4xl font-bold text-white leading-tight">
            Building <br />
            <span className="italic text-4xl text-[#98F3D9] font-light">Global Networks</span>
          </h2>
        </div>

        {/* Right Description */}
        <div className="text-white text-lg max-w-md">
          A symbiotic network of <span className="text-[#98F3D9]"> students, founders, and professional mentors </span>
      ...
      <div className="relative mt-12 w-full">
        <img
          src="/new/map.png" // put your map image in /public folder
          alt="World Map"
