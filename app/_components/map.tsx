    ...
    <section className="relative w-full bg-[#001612] px-8 py-16">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row justify-between">
        ...
        <div className="mb-8 lg:mb-0">
          <h2 className="text-4xl ml-10 font-light text-white leading-tight">
            Building <br />
        ...
        {/* Right Description */}
        <div className="text-white mr-10 text-[109] max-w-md">
      ...
      <div className="relative  w-full flex justify-center">
        <img
          src="/new/Group 40079.png" // place map image inside /public/new/
          alt="World Map"
